...
class Attempt(Base):
    ...
    reranker_metadata: Mapped[dict[str, Any] | None] = mapped_column(JSON)
...
class GameSummary(Base):
    ...
    avg_game_plies: Mapped[float] = mapped_column(Float, nullable=False)
    avg_cpl: Mapped[float | None] = mapped_column(Float)
    evaluated_move_count: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    ...
    illegal_attempts: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    malformed_attempts: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    illegal_rate: Mapped[float] = mapped_column(Float, nullable=False)
    illegal_rate_ci_low: Mapped[float] = mapped_column(Float, default=0, nullable=False)
    illegal_rate_ci_high: Mapped[float] = mapped_column(Float, default=0, nullable=False)
    malformed_rate: Mapped[float] = mapped_column(Float, nullable=False)
    malformed_rate_ci_low: Mapped[float] = mapped_column(Float, default=0, nullable=False)
    malformed_rate_ci_high: Mapped[float] = mapped_column(Float, default=0, nullable=False)
    win_rate: Mapped[float] = mapped_column(Float, default=0, nullable=False)
    win_rate_ci_low: Mapped[float] = mapped_column(Float, default=0, nullable=False)
    win_rate_ci_high: Mapped[float] = mapped_column(Float, default=0, nullable=False)
    low_sample: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
